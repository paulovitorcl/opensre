...
description: "Run OpenSRE in our demo environment within minutes"
---
...
Codespaces will be your coding environment to run any pipeline as an alternative to installing OpenSRE into your own system.

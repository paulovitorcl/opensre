---
title: "Docker"
description: "Install OpenSRE within your Docker under two minutes"
---
...
## 1. Pull the OpenSRE Docker image

Run the following command to pull the latest OpenSRE Docker image:

```
docker pull tracercloud/tracer:latest
```

## 2. Run the OpenSRE container

Start a OpenSRE container with the following command:
...
<Card href="https://app.tracer.cloud/">
  ...
  <div style={{ fontSize: '1.3rem', fontWeight: '700', marginBottom: '1rem', color: 'inherit' }}>
    Once the container is running, you can access OpenSRE
  </div>

---
title: "macOS"
description: "Install OpenSRE locally on your macOS under two minutes"
---
...
While OpenSRE can run on macOS, certain features are limited due to system restrictions.<br/>
  ...
  **– Process recognition:** Less precise than on Linux due to limited access to low-level system data
  ...
  For full functionality, including accurate process visibility and eBPF support, we recommend running OpenSRE directly on a Linux machine.
</Accordion>

---
title: "WDL"
description: "Using OpenSRE with WDL workflows"
---


OpenSRE integrates with WDL (Workflow Description Language) pipelines executed through engines like Cromwell or miniWDL.
...
OpenSRE adds observability that helps teams debug and optimize large WDL workflows:
...
Once the pipeline starts, open the OpenSRE dashboard, and you’ll see each WDL task as a timeline step updating in real time.
